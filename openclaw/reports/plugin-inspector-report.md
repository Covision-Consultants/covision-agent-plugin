...
| -------- | ---------------------- | ----- | -------------------------------------------------------------------------------- | ----------------------------------------------------- | ------------- |
| covision | seam-inventory         | log   | observed 0 hooks, 0 registrations, and 0 manifest contracts                      | -                                                     | -             |
| covision | hook-names-present     | log   | all observed hooks exist in the target OpenClaw hook registry                    | -                                                     | -             |
| covision | api-registrars-present | log   | all observed api.register* calls exist in the target OpenClaw plugin API builder | -                                                     | -             |
| covision | package-metadata       | log   | selected package metadata for plugin contract checks                             | package.json, @covision-admin/covision, version:1.0.1 | -             |
